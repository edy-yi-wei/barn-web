...
export const Constant : ConstantValue = {
  appUrl : 'http://localhost:9999/barn',
  // appUrl: 'http://128.199.173.31:9999/barn',
  spkUrl : '',
  loginUrl : 'http://10.191.85.99:4200/auth/?url=localhost:4200/callback'  
}