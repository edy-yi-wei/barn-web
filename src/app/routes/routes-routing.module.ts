...
const routes: Routes = [
  {
    ...
    children: [
      ...
      {
        path: 'spk',
        loadChildren: () => import('./spk/spk.module').then(m => m.SpkModule),
        data: { title: 'SPK', titleI18n: 'spk' }
      },
      {
        path: 'workspace',
        loadChildren: () => import('./workspace/workspace.module').then(m => m.WorkspaceModule),
        data: { title: 'Workspace', titleI18n: 'workspace' }
      },
      {
        path: 'master',
        loadChildren: () => import('./master/master.module').then(m => m.MasterModule),
        data: { title: 'Master', titleI18n: 'master' }
      },
      {
        path: 'dashboard',
